...
export const misconceptionsSlides = [
    {
        ...
        content: `
            ...
            <div class="example-box">
                ...
                <div id="misconception-1-visual" style="display: flex; justify-content: center; align-items: center; gap: 30px; margin-top: 20px;"></div>
            </div>
        `
    },
    {
        ...
        content: `
            ...
            <div class="example-box">
                ...
                <div id="misconception-2-visual" style="display: flex; justify-content: center; align-items: center; gap: 30px; margin: 20px 0;"></div>
                3/8 = 0.375<br>
                2/3 ≈ 0.667<br>
                Therefore: 3/8 < 2/3
            </div>
    ...
    },
    {
        ...
        content: `
            ...
            <div class="example-box">
                <strong>Correct comparison:</strong><br>
                <div id="misconception-3-visual" style="display: flex; justify-content: center; align-items: center; gap: 30px; margin: 20px 0;"></div>
                7/10 = 0.7<br>
                2/3 ≈ 0.667<br>
    ...
    },
    {
        ...
        content: `
            ...
            <div class="example-box">
                ...
                <div id="misconception-4-visual" style="display: flex; justify-content: center; align-items: center; gap: 30px; margin: 20px 0;"></div>
    ...
    },
    {
        ...
        content: `
            ...
            <div class="simplification-steps">
                <div id="misconception-5-visual" style="display: flex; justify-content: center; align-items: center; gap: 30px; margin: 20px 0;"></div>
